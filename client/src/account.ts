/** The account payload the server returns from /api/enroll and /api/me. Secrets here
 *  live only in memory during setup; they are used to seed files and are never written
